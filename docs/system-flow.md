...
| FFmpeg 하이라이트 · Drive AI/Archive | ✅ | BGM·자막·스타일·길이 (FR-AI-012~015) |
...
| §9 AI 분석 | FR-AI-001~005, 011 (`docs/ai-analysis.md`) |
| §10 AI 영상 | FR-AI-006~010 (`docs/ai-analysis.md`) |
...
| 버전 | 일자 | 변경 내용 | 작성자 |
|------|------|-----------|--------|
| 1.1.0 | 2026-09-13 | AI 장면·Best Shot·하이라이트 1차를 MVP/1차로 반영 | - |
