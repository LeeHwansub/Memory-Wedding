...
> 브랜치: `feat/design-feedback-and-ai`  
...
| FR-AI-005 | 대표 장면(Best Shot) 선정 | ✅ 장면별 confidence 최대 |
...
- `app.gemini.model` ← `GEMINI_MODEL` (default `gemini-2.0-flash`)
...
| 경로 | 역할 |
|------|------|
| `/dashboard/projects/[id]/ai` | 분석 실행·Best Shot·장면별 그리드·메타 표시 |

## 8. 후속

- FR-AI-003 동영상 장면 추출
- FR-AI-006~010 FFmpeg 하이라이트 영상 + Drive `AI/` 저장
- 비동기 Queue (NFR-003)
