...
| FR-AI-012~015 | BGM·자막·스타일·길이 | ✅ 1차 | 프리셋·장면자막·선택 BGM |
| FR-AI-016 | 중복 사진 제거 | ✅ 1차 | aHash 유사도, 분류·Best Shot·하이라이트에서 제외 |
| FR-AI-017~018 | 감정·인물 그룹화 | ❌ | 후속 |
...
3. FR-AI-017~018 · VIDEO 중간 구간 자동 선정
